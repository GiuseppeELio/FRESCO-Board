...
void SD_initialization(bool shieldPresent) {
  ...
  if (dataFile) {
    ...
    if (shieldPresent) {
      ...
      dataFile.println(", T0, PD0, T3, PD3, TSet1");
      Serial.println("Date & Time, Tamb 1, H 1, Tamb2, H2, Tamb 3, H3, TS1, TS2, TS3, TS4, Tbox, Tboard, Irr, Tamb IR, TSky IR, T0, PD0, T3, PD3, TSet1");
    } else {
