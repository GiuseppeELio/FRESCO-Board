...
const int array_length = 20; // Adjust this based on your expected number of elements
...
String getSensorReadings3() {
  ...
  readings3["TPC1"] = array[15];
  readings3["TPC2"] = array[17];
...
String getSensorReadings4() {
  readings4["PD1"] = array[16];
  readings4["PD2"] = array[18];
